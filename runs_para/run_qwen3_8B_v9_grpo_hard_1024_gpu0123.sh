...
export EXP_NAME=${EXP_NAME:-qwen3_8B_v9_grpo_hard_1024_gpu0123_live}
export MODEL_PATH=${MODEL_PATH:-/hyk/algorithm_new/qinghua/yueyang/LUFFY/models_qwen3_8B_base}
...
echo "[v9-grpo-8b] format_mode=$V7_FORMAT_MODE, num_problems=$V7_NUM_PROBLEMS, strict_eos=$V7_REQUIRE_STRICT_EOS, parse_fail_policy=$V7_PARSE_FAIL_POLICY, use_subproblem_prompt=$USE_SUBPROBLEM_PROMPT"
