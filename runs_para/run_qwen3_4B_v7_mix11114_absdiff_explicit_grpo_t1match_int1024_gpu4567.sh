...
export EXP_NAME=${EXP_NAME:-qwen3_4B_v7_mix11114_absdiff_explicit_grpo_t1match_int1024_gpu4567}
...
export V7_T_MIX_MODE=${V7_T_MIX_MODE:-balanced_11114}
...
echo "[v7-full] format_mode=$V7_FORMAT_MODE, num_problems=$V7_NUM_PROBLEMS, strict_eos=$V7_REQUIRE_STRICT_EOS, parse_fail_policy=$V7_PARSE_FAIL_POLICY, use_subproblem_prompt=$USE_SUBPROBLEM_PROMPT, t_mix_mode=$V7_T_MIX_MODE, reward_map_mode=$V7_REWARD_MAP_MODE, prompt_mode=$V7_PROMPT_MODE, one_problem_match=$V7_1_PROBLEM_MATCH"
