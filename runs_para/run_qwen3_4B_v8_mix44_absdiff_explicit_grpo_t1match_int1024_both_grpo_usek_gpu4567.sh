...
export EXP_NAME=${EXP_NAME:-qwen3_4B_v8_mix44_absdiff_explicit_grpo_t1match_int1024_both_grpo_usek_gpu4567}
...
export V8_ADV_GROUP_MODE=${V8_ADV_GROUP_MODE:-both_grpo}
export USE_K_AS_SUBPROBLEM_REWARD=${USE_K_AS_SUBPROBLEM_REWARD:-true}
...
echo "[v8-full] format_mode=$V7_FORMAT_MODE, num_problems=$V7_NUM_PROBLEMS, strict_eos=$V7_REQUIRE_STRICT_EOS, parse_fail_policy=$V7_PARSE_FAIL_POLICY, use_subproblem_prompt=$USE_SUBPROBLEM_PROMPT, t_mix_mode=$V7_T_MIX_MODE, reward_map_mode=$V7_REWARD_MAP_MODE, prompt_mode=$V7_PROMPT_MODE, one_problem_match=$V7_1_PROBLEM_MATCH, adv_group_mode=$V8_ADV_GROUP_MODE, use_k_as_subproblem_reward=$USE_K_AS_SUBPROBLEM_REWARD"
...
python3 -m verl.trainer.main_ppo \
    ...
    data.ts_version='v8' \
    +data.v8_adv_group_mode="$V8_ADV_GROUP_MODE" \
    +data.use_k_as_subproblem_reward=$USE_K_AS_SUBPROBLEM_REWARD \
