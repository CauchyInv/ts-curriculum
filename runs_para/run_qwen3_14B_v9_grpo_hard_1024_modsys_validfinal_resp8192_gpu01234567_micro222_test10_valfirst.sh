...
export EXP_NAME=${EXP_NAME:-qwen3_14B_v9_grpo_hard_1024_modsys_validfinal_resp8192_gpu01234567_micro222_test10_valfirst_live}
...
bash /hyk/algorithm_new/qinghua/yueyang/verl/exp_scripts/train_4B_v7_switchable.sh \
  data.ts_version=v9 \
  data.train_files=/hyk/algorithm_new/qinghua/yueyang/verl/data/int/hard_1024_modified_system_prompt.parquet \
  data.val_files=/hyk/algorithm_new/qinghua/yueyang/verl/data/valid_final.parquet \
  data.max_response_length=8192 \
  actor_rollout_ref.model.path=/hyk/algorithm_new/qinghua/yueyang/LUFFY/Qwen3_14B_Base \
