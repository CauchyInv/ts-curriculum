...
export EXP_NAME=${EXP_NAME:-qwen3_4B_v8_mix44_absdiff_explicit_grpo_t1match_int1024_separate_usek_gpu4567}
...
export V8_ADV_GROUP_MODE=${V8_ADV_GROUP_MODE:-separate}
